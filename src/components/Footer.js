        ...
        <MDBContainer className='text-center text-md-start mt-5'>
          <MDBRow className='mt-3'>
            ...
            <MDBCol md="2" lg="2" xl="2" className='mx-auto mb-4'>
              <h6 className='text-uppercase fw-bold mb-4 hover:text-orange-500'>صفحاتنا</h6>
              <p>
              ...
              <p>
                ...
                <InstagramIcon className='hover:text-orange-500'/> <p className='mx-2 hover:text-orange-500'>انستاغرام</p>
                </a>
              </p>
            </MDBCol>
